...
/**
 * Benchmark for IdealSimplifier based on a polynomial of increasing degree;
 ...
 *
 */
public class SimpliflyPolyNumericBenchmark {
	...
	static ArrayList<Polynomial> subCol;

	public static void main(String[] args) {
		
		system = PreUniverses.newIdealFactorySystem1();
		...
		boolExprFact = PreUniverses.newIdealFactorySystem1().booleanFactory();
		...
		subCol = new ArrayList<Polynomial>();
