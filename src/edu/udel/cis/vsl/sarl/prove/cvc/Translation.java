 ...
 * the division or modulo operation (e.g., the value of the division is the
 * quotient). The format of the constraints can be read below.
 * </p>
 * 
 * @author yanyihao
 * 
...
public class Translation {
	...
	/**
	 * if the translation comes from division or module, side-effects will be
	 * generated, then the side effects will be conjunct as a single fast list:
	 * e.g. the side effects of x%y will be: (y*t__0 + t__1 = x) && (t__1 >= 0
	 * && t__1 < y)
	 * 
	 */
	...
	/**
	 * store all the aux vars generated and used in the result and side effects.
	 */
