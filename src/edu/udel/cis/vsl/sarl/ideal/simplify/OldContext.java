...
public class OldContext {
	...
	private OldContext(SimplifierInfo info,
	...
	/**
	 * Constructs new {@link OldContext} with all empty maps.
	 * 
	 * @param info
	...
	@Override
	public OldContext clone() {
		return new OldContext(info, cloneTreeMap(booleanMap),
