 ...
 * The {@link OldIdealSimplifier} is persistent and will usually continue to live
 * through the lifetime of the JVM.
 * 
 * @author siegel
 */
public class OldIdealSimplifierWorker extends CommonSimplifierWorker {
	 ...
	 */
	public OldIdealSimplifierWorker(SimplifierInfo info, OldContext context) {
		super(info.universe);
