...
import edu.udel.cis.vsl.sarl.ideal.simplify.SimplifierInfo.BoundType;
...
public class IdealSimplifierWorker2 extends CommonSimplifierWorker {
	...
	private BooleanExpression simplifyRelational(BooleanExpression expression) {
		...
		if (result2 != null)
			return result2;
		if (SimplifierInfo.isRelational(result1.operator()))
	...
	private boolean is0byEvaluation(Polynomial poly) {
		IdealFactory id = idealFactory();
		Primitive primitive = SimplifierInfo.findATruePrimitive(poly);
